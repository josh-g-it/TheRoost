...
pub async fn clear_all_data(
    ...
    match credential_store::delete_sgdb_api_key() {
        ...
        Err(e) => tracing::warn!(error = %e, "Failed to delete SteamGridDB API key (may not exist)"),
    }
    ...
    match std::fs::remove_dir_all(&app_data) {
        ...
        Err(e) => tracing::warn!(path = %app_data.display(), error = %e, "Failed to delete app data directory"),
    }
