...
#[tauri::command]
pub fn get_audio_snapshot(db: State<'_, CacheDbHandle>) -> AudioSnapshot {
...
#[tauri::command]
pub fn set_session_volume(pid: u32, volume: f32) -> Result<(), AppError> {
...
#[tauri::command]
pub fn set_session_mute(pid: u32, muted: bool) -> Result<(), AppError> {
...
#[tauri::command]
pub fn set_master_volume(volume: f32) -> Result<(), AppError> {
...
#[tauri::command]
pub fn set_master_mute(muted: bool) -> Result<(), AppError> {
...
#[tauri::command]
pub fn set_default_output_device(device_id: String) -> Result<(), AppError> {
...
#[tauri::command]
pub fn set_default_input_device(device_id: String) -> Result<(), AppError> {
...
#[tauri::command]
pub fn delete_audio_device_alias(
    device_id: String,
    db: State<'_, CacheDbHandle>,
) -> Result<(), AppError> {
    let db = db.lock_or_err("DB")?;
